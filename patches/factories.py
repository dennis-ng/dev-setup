    ...
    def create(config: LLMConfig) -> LLMClient:
        ...
        match provider:
            case 'openai':
                ...
                # Main model from config; small-model slot overridable via env for
                # dual-model setups (fast cheap model for dedup/summary/attr ops).
                import os
                small_model = os.environ.get('GRAPHITI_SMALL_MODEL') or config.model
